...
class CiftciZiraatAtaList extends Component {
    ...
    componentDidMount(id) {
        fetch(`/ziraatmuhendisi/ziraatmuhendisiyleeslenikciftcilerigetir`, {
            method: 'GET',
            headers: {
    ...
    async ekle(id) {
        await fetch(`/ziraatmuhendisi/ciftciziraatmuhendisieslestirmeekle?id=${id}&kooperatifid=${this.props.match.params.id}`, { 
            method: 'POST',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json'
...
export default CiftciZiraatAtaList;
