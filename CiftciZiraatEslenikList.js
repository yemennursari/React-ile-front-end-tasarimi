...
class CiftciZiraatEslenikList extends Component {
    ...
    componentDidMount(id) {
        fetch(`/ziraatmuhendisi/ziraatmuhendisiyleeslenikciftcilerigetir?ziraatmuhendisiid=${this.props.match.params.id}`, {
            headers: {
...
export default CiftciZiraatEslenikList;
