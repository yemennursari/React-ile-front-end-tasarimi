...
class DuyuruCiftciEslestirList extends Component {
    ...
    componentDidMount(id) {
        fetch(`/duyuru/duyuruylaeslenikciftcilerigetir?duyuruid=${this.props.match.params.id}`, {
            headers: {
    ...
    async remove(id) {
     await fetch(`/duyuru/ciftciduyurueslestirmesil?id=${id}`, {
            method: 'DELETE',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json'
...
export default DuyuruCiftciEslestirList;
